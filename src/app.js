...
let canvasPosition = canvas.getBoundingClientRect(); // gets the canvas position details
...
function handleEnemies() {
  ...
  if (frame % enemiesInterval === 0 && score < winningScore) {
    let verticalPosition =
      Math.floor(Math.random() * 5 + 1) * cellSize + cellGap; //Possibly change back
